"""This is my documentation for Documenting_Practical or TAP20."""

class Car:
    """
    :class: This is the superclass that is used in the program from which the other classes will inherit from.
    ...
    def print_model(self):
        """
        Here, the code will print the model and type of Car that has been defined.
    ...
    def print_space(self):
        """
        Here, the code will print the amount of doors and seats that has been defined.
    ...
    def __str__(self):
        """
        Here, the code returns the strings which was also defined in the print statements.
...
class BMW(Car):
    def __init__(self, **arg):
        """
        Creates a BMW class which inherits from Car-class.
        ...
        :param doors: The doors that the var has. Should be part of arg. Key is "doors"
        :type doors: int
...
class Mercedes(Car):
    def __init__(self, **arg):
        """
        Creates a Mercedes class which inherits from Car-class.
...
class Fuel:
    ...
    def __init__(self, **arg):
        ...
        :param liters: How many liters of fuel is needed.
        :type liters: int

        :param type: The type of Fuel needed.
        :type type: str
    ...
    def __str__(self):
        ...
        :return: A string showing what fuel it is.
        """
...
class Lada(Car):
    def __init__(self, **arg):
        """
        Creates a Lada class which inherits from Car-class.
